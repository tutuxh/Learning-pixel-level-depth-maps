...
model_urls = {
    ...
    'dpn92': 'http://data.lip6.fr/cadene/pretrainedmodels/'
		'dpn92.pth',
    'dpn92-extra':
        'http://data.lip6.fr/cadene/pretrainedmodels/'
...
# 832
def dpn68(num_classes=1000, pretrained=False, test_time_pool=True, input_channels=3):
    model = DPN(
    ...
    if input_channels !=3 :
        conv1_1 = InputBlock_RGB_D(input_channels, num_init_features=128, kernel_size=7, padding=3) # conv+bn
        model.features.conv1_1 = conv1_1
    return model


def dpn68b(num_classes=1000, pretrained=False, test_time_pool=True, input_channels=3):
    model = DPN(
        small=True, num_init_features=10, k_r=128, groups=32,
...
# 2688
def dpn92(num_classes=1000, pretrained=False, test_time_pool=True, extra=False, input_channels=3):
    model = DPN(
    ...
    if input_channels !=3 :
        conv1_1 = InputBlock_RGB_D(input_channels, num_init_features=64, kernel_size=3, padding=1) # conv+bn
        model.features.conv1_1 = conv1_1
    return model

# 2688
def dpn98(num_classes=1000, pretrained=False, test_time_pool=True, input_channels=3):
    model = DPN(
    ...
    if input_channels !=3 :
        conv1_1 = InputBlock_RGB_D(input_channels, num_init_features=96, kernel_size=3, padding=1) # conv+bn
        model.features.conv1_1 = conv1_1
    return model

def dpn131(num_classes=1000, pretrained=False, test_time_pool=True, input_channels=3):
    model = DPN(
    ...
    if input_channels !=3 :
        conv1_1 = InputBlock_RGB_D(input_channels, num_init_features=128, kernel_size=3, padding=1) # conv+bn
        model.features.conv1_1 = conv1_1
    return model

def dpn107(num_classes=1000, pretrained=False, test_time_pool=True, input_channels=3):
    model = DPN(
...
class InputBlock_RGB_D(nn.Module):
    def __init__(self, input_channels, num_init_features, kernel_size=7,
                 padding=3, activation_fn=nn.ReLU(inplace=True)):
        super(InputBlock_RGB_D, self).__init__()
        self.conv = nn.Conv2d(input_channels, num_init_features, kernel_size=kernel_size, stride=2, padding=padding, bias=False)
        self.bn = nn.BatchNorm2d(num_init_features, eps=0.001)
        self.act = activation_fn
        self.pool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
